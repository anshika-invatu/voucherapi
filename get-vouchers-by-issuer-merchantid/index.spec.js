...
describe('Get Vouchers by issuer merchantId', () => {

    before(async () => {
        sampleVoucher.issuer.merchantID = sampleMerchantId;
    ...
    it('should throw error on incorrect pass id field', async () => {
        try {
            await request.get(`${helpers.API_URL}/api/v1/issuer-merchants/123-abc/vouchers`, {
                json: true,
                headers: {
    ...
    it('should return vouchers linked to merchant id provided', async () => {
        const url = `${helpers.API_URL}/api/v1/issuer-merchants/${sampleMerchantId}/vouchers`;
