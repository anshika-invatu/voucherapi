...
describe('redeem-voucher-merchant-by-voucher-link', () => {
    before(async () => {
    ...
    describe('Validations', () => {
        ...
        it('should validate partnerNetworkID to match UUID v4 format', async () => {
            try {
                let url = `${helpers.API_URL}/api/v1/vouchers/redeem-voucher-merchant-voucher-link?partnerNetworkID=123`;
                url += '&linkedID=123456';
        ...
        it('should return status code 404 if the voucher does not exist', async () => {
            try {
                let url = `${helpers.API_URL}/api/v1/vouchers/redeem-voucher-merchant-voucher-link?linkedID=123`;
        ...
        it('should validate if the voucher has already been redeemed', async () => {
            try {
                ...
                let url = `${helpers.API_URL}/api/v1/vouchers/redeem-voucher-merchant-voucher-link?partnerNetworkID=${sampleVoucherLink.partitionKey}`;
    ...
    describe('Exchange voucher', () => {
        ...
        it('should update all values when merchantPartner exist.', async () => {
            ...
            sampleVoucher.collectorLimitationsMerchants[0].merchantID = uuid.v4();
